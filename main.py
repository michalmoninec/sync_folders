...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "sync_interval", type=get_valid_interval, help="must be integer, greater than 0"
    )
    return parser
...
def validate_args(
    parser: argparse.ArgumentParser, src: Path, rep: Path, log: Path
) -> None:
...
if __name__ == "__main__":
    ...
    validate_args(parser, args.src_root_path, args.rep_root_path, args.log_dir_path)
